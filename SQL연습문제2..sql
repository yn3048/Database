...
GRANT ALL PRIVILEGES ON `BANK` .* TO 'dpsk3048'@'%';
GRANT ALL PRIVILEGES ON `SHOP` .* TO 'dpsk3048'@'%';
FLUSH PRIVILEGES;
...
insert into `bank_account` values ('101-12-1002', 'S2', '정기적립예금', '830513-1000003', 1020000, '2011-05-13');
